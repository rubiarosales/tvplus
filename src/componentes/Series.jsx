...
export default function Series() {
    ...
    const getTvSeries = (page)=>{
        ...
        axios.get(`https://api.themoviedb.org/3/discover/tv?include_adult=false&include_video=false&language=en-US&page=${page}&sort_by=popularity.desc`, options)
        .then((response) => {
    ...
    return (
        <div className='peliculas-container mt-2 scroll-infinito'id='scroll-infinito' >
